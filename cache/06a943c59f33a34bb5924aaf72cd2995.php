<?php !defined('ROOT_PATH') && exit; /* Tomorrow Framework 模板缓存文件 生成时间:2018-02-12 21:57:12  */ ?>
<html>
	<head>
		<meta charset="utf8">
	...
	<body>
		...
		<div class="container-fluid">
            ...
            <form action="<?php echo APP_PATH.'/index.php/welcome/search';?>" class="navbar-form navbar-default" rol="search" method="post">
                ...
                <button type="submit" class="btn btn-default">搜索</button>
					...
					<div class="alert alert-info">包含关键字 <?=$key?> 的文章</div>					
					...
					<div class="blog-content">
						...
						<p>赞助奥运,马云想将阿里品牌全球化,就在对手腾讯野心勃勃四处战投布局零售业,外界纷纷猜测零售企业下一步的站队队形时,阿里巴巴董事局主席马云在</p>
						<div class="post_left">
